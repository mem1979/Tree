 ...
 * Generated at: 2025-03-14 14:17:47 UTC
...
if (tab.isTitleVisible()) { 
 ...
 if (manager.getDialogLevel() == 0) { 
	...
	for (MetaProperty property: tab.getMetaPropertiesGroupBy()) {
      ...
      out.write("\r\n");
      out.write("\r\n");
      String _jspx_temp0_url = WebEditors.getUrl(tab.getEditor(), tab.getMetaTab());
      String _jspx_temp0_requestEncoding = request.getCharacterEncoding();
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, _jspx_temp0_url + ((_jspx_temp0_url).indexOf('?')>0? '&': '?') + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("viewKeyEditable", _jspx_temp0_requestEncoding)+ "=" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode(String.valueOf(request.getParameter("viewKeyEditable")), _jspx_temp0_requestEncoding), out, false);
      out.write('\r');
      out.write('\n');
